    ...
    versions: Type.Object(
      {
        ...
        geographySchema: Type.Integer({ minimum: 1 }),
        geographySeedPlanSchema: Type.Integer({ minimum: 1 }),
        governancePolicySchema: Type.Integer({ minimum: 1 }),
        governanceSchema: Type.Integer({ minimum: 1 }),
        governanceSeedPlanSchema: Type.Integer({ minimum: 1 }),
        ...
        visualAssetCatalogSchema: Type.Integer({ minimum: 1 }),
        visualScenePlanSchema: Type.Integer({ minimum: 1 }),
        visualStyleKitVersion: Type.Integer({ minimum: 1 }),
