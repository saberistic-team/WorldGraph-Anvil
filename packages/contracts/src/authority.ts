...
export const AuthorityActionSchema = Type.Union([
  ...
  Type.Literal('governance.read'),
  Type.Literal('governance.initialize'),
  Type.Literal('governance.proposal.create'),
  Type.Literal('governance.proposal.sponsor'),
  Type.Literal('governance.proposal.withdraw'),
  Type.Literal('governance.ballot.cast'),
  Type.Literal('governance.candidate.nominate'),
  Type.Literal('governance.candidate.accept'),
  Type.Literal('governance.office.appoint'),
  Type.Literal('governance.office.remove'),
  Type.Literal('governance.override.execute'),
  Type.Literal('governance.result.repair'),
