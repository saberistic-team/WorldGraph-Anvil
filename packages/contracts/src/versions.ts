...
export const CONTRACT_SCHEMA_VERSION = 9 as const;
export const RUNTIME_SCHEMA_VERSION = 9 as const;
...
export const PREVIOUS_COMPILER_VERSION = '1.1.0' as const;
export const COMPILER_VERSION = '1.2.0' as const;
export const COMPILER_CONFIG_SCHEMA_VERSION = 1 as const;
export const LEGACY_COMPILED_ARTIFACT_SCHEMA_VERSION = 1 as const;
export const PREVIOUS_COMPILED_ARTIFACT_SCHEMA_VERSION = 2 as const;
export const COMPILED_ARTIFACT_SCHEMA_VERSION = 3 as const;
...
export const PREVIOUS_SIMULATION_PROCESS_REGISTRY_VERSION = 1 as const;
export const SIMULATION_PROCESS_REGISTRY_VERSION = 2 as const;
...
export const ECONOMY_RECONCILIATION_SCHEMA_VERSION = 2 as const;
