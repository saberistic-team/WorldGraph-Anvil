...
Acceptance evidence recorded in the canonical state includes `pnpm check` (139 unit files/989 tests), the dedicated M11 upgrade-origin 1 file/3 tests, and Playwright 94/94. Full aggregate integration and Compose clean/retained browser recovery were not re-run in this seal window and remain operational residuals.
