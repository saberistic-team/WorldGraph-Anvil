...
- compiler `1.3.0`, compiler configuration schema `1`, the integer bounds and adapter registry version, and an explicit seed. Compiler `1.2.0`, `1.1.0`, and `1.0.0` input/artifact identities remain supported only through their exact named verifier paths.
...
The current primary `compiled_world` artifact contains `CompiledWorldV4`, canonical bytes, input hash, content hash, exact `EconomySeedPlanV2`, exact `GovernanceSeedPlanV1`, and their domain-separated hashes. Artifact schema is `4`; WorldGraph/entity/relationship schema remains `1`. The economy plan retains closed-loop currency, wallet, title, resource, recipe, inventory, business/facility, employment, tax, treasury, and periodic schedule intent. The governance plan adds only schema-constrained charter/institution/law/office/election intent. The database also retains bounded `compiler_input` and `visual_plan` artifacts for exact provenance. Entity states and relationship attributes are strict type-discriminated schema-1 unions, not generic JSON bags. After schema validation, the shared verifier checks exact graph/controller counts and completeness, keys/endpoints, controller correspondence, privacy, both seed-plan stable-key/entity closure, economy arithmetic/references/schedules, governance policy limits/references/windows/seats, and exact plan hashes. Recomputing an outer hash therefore cannot certify a semantically incomplete, corrupt, private, or mismatched artifact.
...
The reviewed compiler `1.3.0`/artifact-4 Harbor City identity is manifest `1a4a917fd635a4da3babc861e5d1d0ba5406b9a727931f5a81e56c9a9cc3fe3f`, input `c3e27bbb6be0c1dc24fa7983a6b99d05b0ed92dae8be1c664303403948cebe74`, artifact `871c5b52863d266421172b5c99aa5974274535070bb3a821606a5e8c5587a484`, economy plan `69ac34721c356be82eb6693620f6cdadb7ec973d128e732ed99a9ee55cf3ef8b`, governance plan `f00b703b39b8b48c2353ab2cbae3ac81643b9442b2cede535a406c27b6fc024c`, 39,613 bytes, 43 entities, 50 relationships, and three controllers. The four-lane golden and standalone CLI gates verify exact current/previous/retained/legacy artifacts. Any later intentional output change requires another compiler/config/artifact version decision, ADR/changelog entry, and reviewed golden update.

Artifact dispatch is explicit. Compiler `1.3.0` pairs only with artifact 4, economy plan 2, and governance plan 1; `1.2.0` pairs with artifact 3/economy plan 2 and has no native governance plan; `1.1.0` pairs with artifact 2/economy plan 1; `1.0.0` pairs with artifact 1. The legacy economy adapter remains deterministic and creator-confirmed and cannot manufacture later commerce intent. Governance adoption is likewise explicit and reasoned; no migration or compatibility verifier rewrites an old artifact or invents value, title, business, tax, charter, law, office, contest, ballot, or term state.
